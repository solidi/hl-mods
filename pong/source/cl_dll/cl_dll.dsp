...
# Begin Custom Build - Copying to \game files\Half-Life\pong\cl_dlls
TargetDir=.\Debug
InputPath=.\Debug\client.dll
SOURCE="$(InputPath)"

"\game files\Half-Life\pong\cl_dlls\client.dll" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy $(TargetDir)\client.dll "\game files\Half-Life\pong\cl_dlls"
