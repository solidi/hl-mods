...
public:
	...
	//start pong
	bool IsPongHudVisible( void );
	void ShowPongHud( void );
	void PlayPongSound ( int sound );
	//end pong
	...
	//start pong
	int MsgFunc_PongPod( const char *pszName, int iSize, void *pbuf );
	int MsgFunc_PongBall( const char *pszName, int iSize, void *pbuf );
	//end pong
