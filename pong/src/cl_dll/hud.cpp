...
//start pong
int __MsgFunc_PongPod(const char *pszName, int iSize, void *pbuf)
{
	if (gViewPort)
		return gViewPort->MsgFunc_PongPod( pszName, iSize, pbuf );
	return 0;
}

int __MsgFunc_PongBall(const char *pszName, int iSize, void *pbuf)
{
	if (gViewPort)
		return gViewPort->MsgFunc_PongBall( pszName, iSize, pbuf );
	return 0;
}
//end pong
...
void CHud :: Init( void )
{
	...
	//start pong
	HOOK_MESSAGE( PongPod );
	HOOK_MESSAGE( PongBall );
	//end pong
