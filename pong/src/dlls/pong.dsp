...
!MESSAGE 
!MESSAGE NMAKE /f "pong.mak" CFG="mp - Win32 Release"
!MESSAGE 
...
TargetPath=.\Releasemp\pong.dll
TargetName=pong
InputPath=.\Releasemp\pong.dll
SOURCE="$(InputPath)"
...
# SUBTRACT LINK32 /profile
# Begin Custom Build - Copying to \half-life\mp\dlls
TargetPath=.\debugmp\pong.dll
TargetName=pong
InputPath=.\debugmp\pong.dll
SOURCE="$(InputPath)"
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /nologo /subsystem:windows /dll /profile /debug /machine:I386 /def:".\pong.def"
# Begin Custom Build - Copying to \game files\Half-Life\pong\dlls
TargetDir=.\Profilemp
InputPath=.\Profilemp\pong.dll
SOURCE="$(InputPath)"

"\game files\Half-Life\pong\dlls\pong.dll" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy $(TargetDir)\pong.dll "\game files\Half-Life\pong\dlls"
