   ...
   info. If Half-Life Pro fails to read any information, it will refresh the 
   file, setting all counts to 0. Also, if the file does not exist, Half-Life 
   Pro will make a default file on starting up.
