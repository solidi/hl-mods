...
//start ice
int __MsgFunc_HealthStat(const char *pszName, int iSize, void *pbuf)
{
	if (gViewPort)
		return gViewPort->MsgFunc_HealthStat( pszName, iSize, pbuf );
	return 0;
}

int __MsgFunc_Rune(const char *pszName, int iSize, void *pbuf)
{
	if (gViewPort)
		return gViewPort->MsgFunc_Rune( pszName, iSize, pbuf );
	return 0;
}
//end ice
