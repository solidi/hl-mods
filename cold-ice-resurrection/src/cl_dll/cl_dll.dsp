...
# Begin Custom Build - Copying to D:\half-life\cir\cl_dlls
TargetDir=.\Debug
InputPath=.\Debug\client.dll
SOURCE="$(InputPath)"

"D:\half-life\cir\cl_dlls\client.dll" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy $(TargetDir)\client.dll "D:\half-life\cir\cl_dlls"
