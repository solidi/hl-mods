...
void CGrenade::Explode( TraceResult *pTrace, int bitsDamageType )
{
	...
	MESSAGE_BEGIN( MSG_PAS, SVC_TEMPENTITY, pev->origin );
		...
		WRITE_BYTE( TE_EXPLFLAG_NOSOUND/*TE_EXPLFLAG_NONE*/ );
	MESSAGE_END();
	//end ice
	...
	{
		case 0:	EMIT_SOUND(ENT(pev), CHAN_AUTO, "weapons/env_explode1.wav", 1.0, ATTN_NORM);	break;
		case 1:	EMIT_SOUND(ENT(pev), CHAN_AUTO, "weapons/env_explode2.wav", 1.0, ATTN_NORM);	break;
		case 2:	EMIT_SOUND(ENT(pev), CHAN_AUTO, "weapons/env_explode3.wav", 1.0, ATTN_NORM);	break;
	}

	EMIT_SOUND(ENT(pev), CHAN_VOICE, "weapons/env_debris1.wav", 0.55, ATTN_NORM);
	//end ice
...
*/
	...
	UTIL_TraceLine ( pev->origin + gpGlobals->v_forward * 8, pev->origin - gpGlobals->v_forward * 6,  dont_ignore_monsters, ENT(pev), & tr);
