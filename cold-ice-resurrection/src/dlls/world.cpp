...
DLL_DECALLIST gDecals[] = {
	...
	//start ice
	{ "{crack4", 0 },		// DECAL_PIPESMASH
	{ "{foot_r", 0 },       // DECAL_RFOOT
	{ "{foot_l", 0 },       // DECAL_LFOOT
	//end ice
};
...
// sounds used from C physics code
	...
	//start ice
	PRECACHE_SOUND ("weapons/env_ric1.wav");
	PRECACHE_SOUND ("weapons/env_ric2.wav");
	PRECACHE_SOUND ("weapons/env_ric3.wav");
	PRECACHE_SOUND ("weapons/env_ric4.wav");
	//end ice
//
