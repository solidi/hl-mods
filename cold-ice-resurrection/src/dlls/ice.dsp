...
!MESSAGE 
!MESSAGE NMAKE /f "ice.mak" CFG="mp - Win32 Release"
!MESSAGE 
...
TargetPath=.\Releasemp\ice.dll
TargetName=ice
InputPath=.\Releasemp\ice.dll
SOURCE="$(InputPath)"
...
# SUBTRACT LINK32 /profile
# Begin Custom Build - Copying to \half-life\mp\dlls
TargetPath=.\debugmp\ice.dll
TargetName=ice
InputPath=.\debugmp\ice.dll
SOURCE="$(InputPath)"
...
# Begin Custom Build - Copying to D:\half-life\cir\dlls
TargetDir=.\Profilemp
InputPath=.\Profilemp\ice.dll
SOURCE="$(InputPath)"

"D:\half-life\cir\dlls\ice.dll" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy $(TargetDir)\ice.dll "D:\half-life\cir\dlls\ice.dll"
...
SOURCE=.\weap_chainsaw.cpp
# End Source File
# Begin Source File

SOURCE=.\weap_deagle.cpp
# End Source File
# Begin Source File

SOURCE=.\weap_pipe.cpp
# End Source File
# Begin Source File

SOURCE=.\weap_pulsegun.cpp
# End Source File
# Begin Source File

SOURCE=.\weap_sawedoff.cpp
# End Source File
# Begin Source File
