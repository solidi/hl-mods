...
public:
	...
	//start ice
	bool IsCirHUDVisible( void );
    void ShowCirHUD( void );
    //end ice
	...
	//start ice
	int MsgFunc_HealthStat( const char *pszName, int iSize, void *pbuf );
	int MsgFunc_Rune( const char *pszName, int iSize, void *pbuf );
	//end ice
