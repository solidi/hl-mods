...
#define CONTROL_WINAMP_PLAY				2
#define CONTROL_WINAMP_STOP				4
#define CONTROL_WINAMP_NEXT				8
#define CONTROL_WINAMP_PREV				16
#define CONTROL_WINAMP_VOLUMEUP			32
#define CONTROL_WINAMP_VOLUMEDOWN		64
