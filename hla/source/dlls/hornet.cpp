...
void CHornet :: TrackTarget ( void )
{
	...
	if (gpGlobals->time > m_flStopAttack)
	{
		...
		//start hlpro2
		CBasePlayer *ptr = (CBasePlayer *)CBaseEntity::Instance(pev->owner);
		ptr->m_iMissedHits[WEAPON_HORNETGUN]++;	
		ptr->DisplayAccuracy(WEAPON_HORNETGUN, "Hornetgun");
		//end hlpro2
		return;
	}
...
void CHornet::DieTouch ( CBaseEntity *pOther )
{
	...
	{// do the damage
		...
		//start hlpro2
		ptr->m_iLandedHits[WEAPON_HORNETGUN]++;	
		ptr->DisplayAccuracy(WEAPON_HORNETGUN, "Hornetgun");
		//end hlpro2
	}
	else
