...
General Issues
[x] MWHEELDOWN in config doesnt have Mouse Wheel Up associated text
[x] roll through all gameplay and ask AI what mutator and runes to filter?
...
[x] bounce2 - inside tunnel, spawn facing wall?
[x] frosty - stuck in wall, second level
...
voting
[x] dynamic map voting driven by mapcycle.txt
[x] ask AI to place elements into a scrollable window?
Bugs
[x] Host_Error: UserMsg: Not Present on Client 134
...
[x] Assists should not credit same-team member if team damage is off
[x] Disable "busters" in chilldemic / remove egon from world
[x] Patch possible ammo crash - see code fix from PM on 12/25/2025
