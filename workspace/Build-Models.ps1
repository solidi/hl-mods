...
if ($clean -eq $true) {
    ...
    [void](New-Item -ItemType directory -Path $redistDir\models\player\ice_bro)
...
try {
    ...
    Compile-Player "ice_bro" $binDir $modelsdir $redistDir
    ...
    Compile-Model $binDir "v_forcegrab" $modelsdir\hd $redisthddir\models
