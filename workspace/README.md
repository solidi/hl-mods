...
1. Two dependenices are required
    1. On Windows (10, or 11), install portable [Powershell 7.3.0+](https://github.com/PowerShell/PowerShell/releases/tag/v7.3.0).
