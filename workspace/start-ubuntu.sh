...
/usr/games/steam steam://rungameid/70//-console%20-dev%20-condebug%20-game%20${icefolder}%20-windowed%20-gl%20-w%20640%20-h%20480%20+developer%202%20+log%20on%20+sv_lan%201%20+map%20stalkyard%20+deathmatch%201%20+maxplayers%20${maxplayers}+_sethdmodels%20${hiDef}
